...
class PrayerNotificationService {
  ...
  void _showNotification(String title, String body) {
    // This is just a placeholder as we've removed the actual notification library
    // to fix the Android v1 embedding issue
    debugPrint('NOTIFICATION: $title - $body');
    
    // When we re-add the notification library, we'll implement proper notifications here
  }
